...
def create_question(question_text, days):
    ...
    number of 'days' offset to now (negative for question publicshed in the post ,
...
class QuestionMethodTests(TestCase):
    ...
    def test_was_published_recently_with_future_question(self):
        """
        was_published_recently() should return False for question whose pub date is in the future.
        """
    ...
    def test_was_published_recently_old_question(self):
        """
        was_published_recently() should return False questions whose
